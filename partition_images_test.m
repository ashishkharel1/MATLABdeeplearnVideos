close all;
clear bbox_table_pred; clear bbox_table_actual;
run=1;

for i = 1:1 %change this

path1='C:\Users\Asis\Desktop\training\testing_uncropped\';
...
len=size(Files);
len= len(1);
%     delete 'C:\Users\Asis\Desktop\training\testing_cropped\*.tif';
...
%     blockSizeR = round(size(a,1)/32); % Rows in block.
%     blockSizeC = round(size(a,2)/42); % Columns in block.
