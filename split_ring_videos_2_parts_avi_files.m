%%splits from t0-6 to t0 and t0 to t0+6
iter=0;
...
%     file_part1=cookedframes(:,:,1,1:frame_number+1);
% %     file_part2=cookedframes(:,:,1,frame_number-3:frame_number+3);
%     file_part3=cookedframes(:,:,1,frame_number+1:vr.duration);
       if frame_number<=5
           file_part1=cookedframes(:,:,1,1:frame_number+1);
       else
           file_part1=cookedframes(:,:,1,frame_number-5:frame_number+1);
       end
           
           
%        file_part1=cookedframes(:,:,1,frame_number-5:frame_number+1);
       if vr.duration-frame_number<5
           file_part3=cookedframes(:,:,1,frame_number+1:frame_number+vr.duration-frame_number);
       else
       file_part3=cookedframes(:,:,1,frame_number+1:frame_number+5);
       end
