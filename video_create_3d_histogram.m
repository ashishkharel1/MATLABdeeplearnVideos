...
path1='C:\Users\asis\Desktop\Research\Summer 2021\Ring_timing\batch_converted_imagej\';
...
for iteration=1:size(filenumbers,2)
    ...
    filename=strcat('ring',filenumber,'.avi');
...
%     for k = 23:33
    ...
    histo=zeros(256,vr.Duration);
        for l=1:vr.duration
            frame = read(vr,l);
            frame=rgb2gray(frame);
            histo(:,l)=imhist(frame);
